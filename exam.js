...
console.log( militaryUnit.commandStructure.chiefOfStaff);


function Mission1(obg){
    let list = []
    list.push(obg.commandStructure.chiefOfStaff.name)
    list.push(obg.commandStructure.chiefOfStaff.rank)
    list.push(obg.commandStructure.chiefOfStaff.contact.phone)
    return list
}

function Mission2(obg){
     let count = obg.personnel.length
     return count
}
